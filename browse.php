          ...
          <div class="row">
              ...
              <div class="featured-games header-text">
                ...
                <div class="owl-features owl-carousel">
                  <div class="item">
                    ...
                    <h4>KTM 600<br><span>5000$</span></h4>
                    <ul>
                  ...
                  <div class="item">
                    ...
                    <h4>Harley<br><span>8000$</span></h4>
                    <ul>
                      <li><i class="fa fa-star"></i> 4.8</li>
                      <li><i class="fa fa-download"></i> 2.3M</li>
                    </ul>
                  ...
                  <div class="item">
                    ...
                    <h4>Harley<br><span>2900$</span></h4>
                    <ul>
                      <li><i class="fa fa-star"></i> 4.8</li>
                      <li><i class="fa fa-download"></i> 2.3M</li>
                    </ul>
                  ...
                  <div class="item">
                    ...
                    <h4>Suzuki<br><span>3999$</span></h4>
                    <ul>
                      <li><i class="fa fa-star"></i> 4.8</li>
                      <li><i class="fa fa-download"></i> 2.3M</li>
                    </ul>
                  ...
                  <div class="item">
                    ...
                    <h4>Kawasaki<br><span>6000$</span></h4>
                    <ul>
                      <li><i class="fa fa-star"></i> 4.8</li>
                      <li><i class="fa fa-download"></i> 2.3M</li>
                    </ul>
            ...
            <div class="col-lg-4">
              <div class="top-downloaded">
                <div class="heading-section">
                  <h4><em>Top</em> Sellers</h4>
                </div>
                <ul>
                  <li>
                    <img src="assets/images/moto2.jpg" alt="" class="templatemo-item">
                    <h4>Yamaha</h4>
                    <h6>Comfort</h6>
                  ...
                  <li>
                    <img src="assets/images/moto8.jpg" alt="" class="templatemo-item">
                    <h4>Kawasaki</h4>
                    <h6>Speed</h6>
                    <span><i class="fa fa-star" style="color: yellow;"></i> 4.9</span>
                    <span><i class="fa fa-download" style="color: #ec6090;"></i> 2.2M</span>
                  ...
                  <li>
                    <img src="assets/images/moto4.jpg" alt="" class="templatemo-item">
                    <h4>Honda</h4>
                    <h6>Cruise</h6>
                    <span><i class="fa fa-star" style="color: yellow;"></i> 4.9</span>
                    <span><i class="fa fa-download" style="color: #ec6090;"></i> 2.2M</span>
                ...
                <div class="text-button">
                  <a href="profile.html">View All Motorbikes</a>
                </div>
              </div>
            </div>
          </div>
